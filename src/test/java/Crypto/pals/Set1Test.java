...
class Set1Test {
    ...
    public void challenge3() {
        ...
        assertEquals("Cooking MC's like a pound of bacon",
                SingleByteXORCipher
                        .decodeOneCharacterXor("1b37373331363f78151b7f2b783431333d78397828372d363c78373e783a393b3736"));
    }
    ...
    public void challenge7() throws Exception {
        ...
        byte[] base64Ciphertext = Base64.decode(readFileSet1Ex7());
        String key = "YELLOW SUBMARINE";

        AESECB aesecb = new AESECB();
        byte[] plaintext = aesecb.decrypt(base64Ciphertext, CodecSupport.toBytes(key));
    
        assertEquals(expected, CodecSupport.toString(plaintext));
    }
